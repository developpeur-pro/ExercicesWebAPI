...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobOverview_v67.Entities.Equipe", b =>
                {
            ...
            modelBuilder.Entity("JobOverview_v67.Entities.Filiere", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("JobOverview_v67.Entities.Logiciel", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("JobOverview_v67.Entities.Metier", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("JobOverview_v67.Entities.Module", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("JobOverview_v67.Entities.Personne", b =>
                {
            ...
            modelBuilder.Entity("JobOverview_v67.Entities.Release", b =>
                {
            ...
            modelBuilder.Entity("JobOverview_v67.Entities.Service", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("JobOverview_v67.Entities.Version", b =>
                {
            ...
            modelBuilder.Entity("JobOverview_v67.Entities.Equipe", b =>
                {
                    b.HasOne("JobOverview_v67.Entities.Filiere", null)
                        .WithMany("Equipes")
                        .HasForeignKey("CodeFiliere")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("JobOverview_v67.Entities.Service", "Service")
                        .WithMany()
            ...
            modelBuilder.Entity("JobOverview_v67.Entities.Metier", b =>
                {
                    b.HasOne("JobOverview_v67.Entities.Service", null)
                        .WithMany()
                        .HasForeignKey("CodeService")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("JobOverview_v67.Entities.Module", b =>
                {
                    b.HasOne("JobOverview_v67.Entities.Logiciel", null)
                        .WithMany("Modules")
                        .HasForeignKey("CodeLogiciel")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("JobOverview_v67.Entities.Module", null)
            ...
            modelBuilder.Entity("JobOverview_v67.Entities.Personne", b =>
                {
                    b.HasOne("JobOverview_v67.Entities.Equipe", null)
                        .WithMany("Personnes")
                        .HasForeignKey("CodeEquipe")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("JobOverview_v67.Entities.Metier", "Métier")
                        .WithMany()
                        .HasForeignKey("CodeMetier")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("JobOverview_v67.Entities.Personne", null)
                        .WithMany()
            ...
            modelBuilder.Entity("JobOverview_v67.Entities.Release", b =>
                {
                    b.HasOne("JobOverview_v67.Entities.Version", null)
                        .WithMany("Releases")
