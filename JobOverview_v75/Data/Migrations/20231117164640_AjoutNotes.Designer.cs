...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobOverview_v75.Entities.Equipe", b =>
                {
            ...
            modelBuilder.Entity("JobOverview_v75.Entities.Filiere", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("JobOverview_v75.Entities.Logiciel", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("JobOverview_v75.Entities.Metier", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("JobOverview_v75.Entities.Module", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("JobOverview_v75.Entities.Personne", b =>
                {
            ...
            modelBuilder.Entity("JobOverview_v75.Entities.Release", b =>
                {
            ...
            modelBuilder.Entity("JobOverview_v75.Entities.Service", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("JobOverview_v75.Entities.Version", b =>
                {
            ...
            modelBuilder.Entity("JobOverview_v75.Entities.Equipe", b =>
                {
                    b.HasOne("JobOverview_v75.Entities.Filiere", null)
                        .WithMany("Equipes")
                        .HasForeignKey("CodeFiliere")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("JobOverview_v75.Entities.Service", "Service")
                        .WithMany()
            ...
            modelBuilder.Entity("JobOverview_v75.Entities.Metier", b =>
                {
                    b.HasOne("JobOverview_v75.Entities.Service", null)
                        .WithMany()
                        .HasForeignKey("CodeService")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("JobOverview_v75.Entities.Module", b =>
                {
                    b.HasOne("JobOverview_v75.Entities.Logiciel", null)
                        .WithMany("Modules")
                        .HasForeignKey("CodeLogiciel")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("JobOverview_v75.Entities.Module", null)
            ...
            modelBuilder.Entity("JobOverview_v75.Entities.Personne", b =>
                {
                    b.HasOne("JobOverview_v75.Entities.Equipe", null)
                        .WithMany("Personnes")
                        .HasForeignKey("CodeEquipe")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("JobOverview_v75.Entities.Metier", "Métier")
                        .WithMany()
                        .HasForeignKey("CodeMetier")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("JobOverview_v75.Entities.Personne", null)
                        .WithMany()
            ...
            modelBuilder.Entity("JobOverview_v75.Entities.Release", b =>
                {
                    b.HasOne("JobOverview_v75.Entities.Version", null)
                        .WithMany("Releases")
