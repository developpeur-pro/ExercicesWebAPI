...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobOverview_v77.Entities.Equipe", b =>
                {
            ...
            modelBuilder.Entity("JobOverview_v77.Entities.Personne", b =>
                {
            ...
            modelBuilder.Entity("JobOverview_v77.Entities.Equipe", b =>
                {
                    b.HasOne("JobOverview_v77.Entities.Filiere", null)
                        .WithMany("Equipes")
            ...
            modelBuilder.Entity("JobOverview_v77.Entities.Module", b =>
                {
                    b.HasOne("JobOverview_v77.Entities.Logiciel", null)
                        .WithMany("Modules")
                        .HasForeignKey("CodeLogiciel")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("JobOverview_v77.Entities.Module", null)
            ...
            modelBuilder.Entity("JobOverview_v77.Entities.Personne", b =>
                {
                    b.HasOne("JobOverview_v77.Entities.Equipe", null)
                        .WithMany("Personnes")
                        .HasForeignKey("CodeEquipe")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("JobOverview_v77.Entities.Metier", "Métier")
                        .WithMany()
            ...
            modelBuilder.Entity("JobOverview_v77.Entities.Release", b =>
                {
                    b.HasOne("JobOverview_v77.Entities.Version", null)
                        .WithMany("Releases")
