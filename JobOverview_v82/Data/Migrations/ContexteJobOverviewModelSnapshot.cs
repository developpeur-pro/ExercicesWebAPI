...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Activite", b =>
                {
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.ActiviteMetier", b =>
                {
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Equipe", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Filiere", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Logiciel", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Metier", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Module", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Personne", b =>
                {
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Release", b =>
                {
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Service", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Tache", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Travail", b =>
                {
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Version", b =>
                {
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.ActiviteMetier", b =>
                {
                    b.HasOne("JobOverview_v82.Entities.Activite", null)
                        .WithMany()
                        .HasForeignKey("CodeActivite")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JobOverview_v82.Entities.Metier", null)
                        .WithMany()
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Equipe", b =>
                {
                    b.HasOne("JobOverview_v82.Entities.Filiere", null)
                        .WithMany("Equipes")
                        .HasForeignKey("CodeFiliere")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("JobOverview_v82.Entities.Service", "Service")
                        .WithMany()
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Metier", b =>
                {
                    b.HasOne("JobOverview_v82.Entities.Service", null)
                        .WithMany()
                        .HasForeignKey("CodeService")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Module", b =>
                {
                    b.HasOne("JobOverview_v82.Entities.Logiciel", null)
                        .WithMany("Modules")
                        .HasForeignKey("CodeLogiciel")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("JobOverview_v82.Entities.Module", null)
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Personne", b =>
                {
                    b.HasOne("JobOverview_v82.Entities.Equipe", null)
                        .WithMany("Personnes")
                        .HasForeignKey("CodeEquipe")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("JobOverview_v82.Entities.Metier", "Métier")
                        .WithMany()
                        .HasForeignKey("CodeMetier")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("JobOverview_v82.Entities.Personne", null)
                        .WithMany()
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Release", b =>
                {
                    b.HasOne("JobOverview_v82.Entities.Version", null)
                        .WithMany("Releases")
            ...
            modelBuilder.Entity("JobOverview_v82.Entities.Travail", b =>
                {
                    b.HasOne("JobOverview_v82.Entities.Tache", null)
                        .WithMany("Travaux")
